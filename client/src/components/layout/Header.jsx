...
import { HomeIcon, LinkIcon, HeartIcon } from '@heroicons/react/24/outline';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <nav className="flex space-x-1">
                        ...
                        <Link
                            to="/healthz"
                            className={`inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${isActive('/healthz')
